...
def resolve_experiment_tag(training_cfg):
                                                                                
    base_name = training_cfg.get("name", "experiment")
    task_name = training_cfg.get("task_name")

                                                                       
    if not task_name:
        task_name = training_cfg.get("current_time", base_name)

    if task_name and task_name != base_name:
        return f"{base_name}_{task_name}"
    return base_name
